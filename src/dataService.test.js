...
describe('createPost', () => {
  it('creates an open post and notifies everyone except the author', async () => {
    const post = await Board.createPost({ dutyNumber: 'BT100', weekCommencing: '2026-06-21', weekType: 'mon-fri', note: '', authorId: 'u-paul' })
...
describe('applyToPost', () => {
  let post
  beforeEach(async () => { post = await Board.createPost({ dutyNumber: 'BT100', weekCommencing: '2026-06-21', weekType: 'mon-fri', note: '', authorId: 'u-paul' }) })
...
describe('fetchPosts filter & notifications', () => {
  it('filters open vs closed', async () => {
    const p = await Board.createPost({ dutyNumber: 'BT100', weekCommencing: '2026-06-21', weekType: 'mon-fri', note: '', authorId: 'u-paul' })
